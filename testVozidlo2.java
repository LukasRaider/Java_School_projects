...
{   
    ...
    {   
        ...
        {                                                   //
            ...
            case 3: System.out.print(" na dálnici"); break; //       
        }                                                   //
        String[] poleKomunikace={" (v obci)"," (mimo obec)"," (na dálnici)"};  //druhý zpùsob
        System.out.println(poleKomunikace[k-1]);            //druhý zpùsob
    }
}
